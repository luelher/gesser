...
/**
 * Spmenenc filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseSpmenencFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'des_men'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'fec_emis'  => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
      'comprom'   => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      'des_men'   => new sfValidatorPass(array('required' => false)),
      ...
      'comprom'   => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ...
    $this->widgetSchema->setNameFormat('spmenenc_filters[%s]');
