...
/**
 * Ambentre filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseAmbentreFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'co_es_mo'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'co_es_mo'   => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ambentre_filters[%s]');
