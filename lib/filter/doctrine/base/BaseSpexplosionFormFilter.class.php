...
/**
 * Spexplosion filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseSpexplosionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'expnfe'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'expnfe'     => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('spexplosion_filters[%s]');
