...
/**
 * Spimplosion filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseSpimplosionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'maxima'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'maxima'     => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('spimplosion_filters[%s]');
