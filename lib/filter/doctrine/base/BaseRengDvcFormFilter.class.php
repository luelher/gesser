...
/**
 * RengDvc filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseRengDvcFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo_prec'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('reng_dvc_filters[%s]');
