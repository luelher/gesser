...
/**
 * RengPag filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseRengPagFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'comi_porc'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'comi_linea'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'comi_conc'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'comi_art'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'dppago_tmp'   => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'reng_ncr'     => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'co_ven'       => new sfValidatorPass(array('required' => false)),
      'comi_porc'    => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'comi_linea'   => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'comi_conc'    => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'comi_art'     => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('reng_pag_filters[%s]');
