...
/**
 * RmaEntp filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseRmaEntpFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ent_prov'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'ent_prov'   => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('rma_entp_filters[%s]');
