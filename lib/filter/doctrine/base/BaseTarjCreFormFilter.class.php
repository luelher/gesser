...
/**
 * TarjCre filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseTarjCreFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'des_tar'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'des_tar'  => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('tarj_cre_filters[%s]');
