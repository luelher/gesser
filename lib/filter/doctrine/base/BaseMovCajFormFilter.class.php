 ...
 */
abstract class BaseMovCajFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mon_dep'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'movt_ori'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'movt_gen'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'tracaja'    => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'doc_sel'    => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ));
    ...
    $this->setValidators(array(
      ...
      'mon_dep'    => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      ...
      'movt_ori'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'movt_gen'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'tracaja'    => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'doc_sel'    => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ));

    $this->widgetSchema->setNameFormat('mov_caj_filters[%s]');
