...
/**
 * Spentre filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseSpentreFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ent_des'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'ent_des'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('spentre_filters[%s]');
