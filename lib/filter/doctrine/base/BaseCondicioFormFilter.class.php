...
/**
 * Condicio filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseCondicioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'cond_des'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'dias_cred' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'cond_des'  => new sfValidatorPass(array('required' => false)),
      'dias_cred' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('condicio_filters[%s]');
