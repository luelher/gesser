...
/**
 * Ambtras filter form base class.
 *
 * @package    gesser
 * @subpackage filter
 ...
 */
abstract class BaseAmbtrasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'tras_num'   => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      'tras_num'   => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ...
    $this->widgetSchema->setNameFormat('ambtras_filters[%s]');
