...
Doctrine_Manager::getInstance()->bindComponent('RengPlv', 'profit');
 ...
 * @method RengPlv   setFactNum()    Sets the current record's "fact_num" value
 * @method RengPlv   setRengNum()    Sets the current record's "reng_num" value
 * @method RengPlv   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengPlv   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengPlv   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengPlv   setCoArt()      Sets the current record's "co_art" value
 * @method RengPlv   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengPlv   setTotalArt()   Sets the current record's "total_art" value
 * @method RengPlv   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengPlv   setPendiente()  Sets the current record's "pendiente" value
 * @method RengPlv   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengPlv   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengPlv   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengPlv   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengPlv   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengPlv   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengPlv   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengPlv   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengPlv   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengPlv   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengPlv   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengPlv   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengPlv   setAnulado()    Sets the current record's "anulado" value
 * @method RengPlv   setDesArt()     Sets the current record's "des_art" value
 * @method RengPlv   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengPlv   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengPlv   setComentario() Sets the current record's "comentario" value
 * @method RengPlv   setRowguid()    Sets the current record's "rowguid" value
 * @method RengPlv   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengPlv   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengPlv   setOtros()      Sets the current record's "otros" value
 * @method RengPlv   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengPlv   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengPlv   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengPlv   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengPlv   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengPlv   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengPlv   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengPlv   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengPlv   setAux01()      Sets the current record's "aux01" value
 * @method RengPlv   setAux02()      Sets the current record's "aux02" value
 * @method RengPlv   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengPlv   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengPlv   setArt()        Sets the current record's "Art" value
 * @method RengPlv   setSubAlma()    Sets the current record's "SubAlma" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengPlv extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_plv');
