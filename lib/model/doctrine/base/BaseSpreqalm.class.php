...
Doctrine_Manager::getInstance()->bindComponent('Spreqalm', 'profit');
 ...
 * @method Spreqalm  setReqNum()     Sets the current record's "req_num" value
 * @method Spreqalm  setFecha()      Sets the current record's "fecha" value
 * @method Spreqalm  setAlmOrig()    Sets the current record's "alm_orig" value
 * @method Spreqalm  setAlmDest()    Sets the current record's "alm_dest" value
 * @method Spreqalm  setMotivoGlo()  Sets the current record's "motivo_glo" value
 * @method Spreqalm  setConfirma()   Sets the current record's "confirma" value
 * @method Spreqalm  setFecConf()    Sets the current record's "fec_conf" value
 * @method Spreqalm  setInactivo()   Sets the current record's "inactivo" value
 * @method Spreqalm  setCampo1()     Sets the current record's "campo1" value
 * @method Spreqalm  setCampo2()     Sets the current record's "campo2" value
 * @method Spreqalm  setCampo3()     Sets the current record's "campo3" value
 * @method Spreqalm  setCampo4()     Sets the current record's "campo4" value
 * @method Spreqalm  setCampo5()     Sets the current record's "campo5" value
 * @method Spreqalm  setCampo6()     Sets the current record's "campo6" value
 * @method Spreqalm  setCampo7()     Sets the current record's "campo7" value
 * @method Spreqalm  setCampo8()     Sets the current record's "campo8" value
 * @method Spreqalm  setCoUsIn()     Sets the current record's "co_us_in" value
 * @method Spreqalm  setFeUsIn()     Sets the current record's "fe_us_in" value
 * @method Spreqalm  setCoUsMo()     Sets the current record's "co_us_mo" value
 * @method Spreqalm  setFeUsMo()     Sets the current record's "fe_us_mo" value
 * @method Spreqalm  setCoUsEl()     Sets the current record's "co_us_el" value
 * @method Spreqalm  setFeUsEl()     Sets the current record's "fe_us_el" value
 * @method Spreqalm  setRevisado()   Sets the current record's "revisado" value
 * @method Spreqalm  setReqnfe()     Sets the current record's "reqnfe" value
 * @method Spreqalm  setSeriales()   Sets the current record's "seriales" value
 * @method Spreqalm  setCoSucu()     Sets the current record's "co_sucu" value
 * @method Spreqalm  setAnulada()    Sets the current record's "anulada" value
 * @method Spreqalm  setDisCen()     Sets the current record's "dis_cen" value
 * @method Spreqalm  setFeccom()     Sets the current record's "feccom" value
 * @method Spreqalm  setNumcom()     Sets the current record's "numcom" value
 * @method Spreqalm  setOdpNum()     Sets the current record's "odp_num" value
 * @method Spreqalm  setComentario() Sets the current record's "comentario" value
 * @method Spreqalm  setTrasNum()    Sets the current record's "tras_num" value
 * @method Spreqalm  setRowguid()    Sets the current record's "rowguid" value
 * @method Spreqalm  setTrasnfe()    Sets the current record's "trasnfe" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseSpreqalm extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('spreqalm');
