...
Doctrine_Manager::getInstance()->bindComponent('NotDep', 'profit');
 ...
 * @method NotDep    setFactNum()    Sets the current record's "fact_num" value
 * @method NotDep    setContrib()    Sets the current record's "contrib" value
 * @method NotDep    setNombre()     Sets the current record's "nombre" value
 * @method NotDep    setRif()        Sets the current record's "rif" value
 * @method NotDep    setNit()        Sets the current record's "nit" value
 * @method NotDep    setStatus()     Sets the current record's "status" value
 * @method NotDep    setComentario() Sets the current record's "comentario" value
 * @method NotDep    setDescrip()    Sets the current record's "descrip" value
 * @method NotDep    setSaldo()      Sets the current record's "saldo" value
 * @method NotDep    setFecEmis()    Sets the current record's "fec_emis" value
 * @method NotDep    setFecVenc()    Sets the current record's "fec_venc" value
 * @method NotDep    setCoCli()      Sets the current record's "co_cli" value
 * @method NotDep    setCoVen()      Sets the current record's "co_ven" value
 * @method NotDep    setCoTran()     Sets the current record's "co_tran" value
 * @method NotDep    setDirEnt()     Sets the current record's "dir_ent" value
 * @method NotDep    setFormaPag()   Sets the current record's "forma_pag" value
 * @method NotDep    setTotBruto()   Sets the current record's "tot_bruto" value
 * @method NotDep    setTotNeto()    Sets the current record's "tot_neto" value
 * @method NotDep    setGlobDesc()   Sets the current record's "glob_desc" value
 * @method NotDep    setTotReca()    Sets the current record's "tot_reca" value
 * @method NotDep    setPorcGdesc()  Sets the current record's "porc_gdesc" value
 * @method NotDep    setPorcReca()   Sets the current record's "porc_reca" value
 * @method NotDep    setTotalUc()    Sets the current record's "total_uc" value
 * @method NotDep    setTotalCp()    Sets the current record's "total_cp" value
 * @method NotDep    setTotFlete()   Sets the current record's "tot_flete" value
 * @method NotDep    setMontoDev()   Sets the current record's "monto_dev" value
 * @method NotDep    setTotklu()     Sets the current record's "totklu" value
 * @method NotDep    setAnulada()    Sets the current record's "anulada" value
 * @method NotDep    setImpresa()    Sets the current record's "impresa" value
 * @method NotDep    setIva()        Sets the current record's "iva" value
 * @method NotDep    setIvaDev()     Sets the current record's "iva_dev" value
 * @method NotDep    setFeccom()     Sets the current record's "feccom" value
 * @method NotDep    setNumcom()     Sets the current record's "numcom" value
 * @method NotDep    setTasa()       Sets the current record's "tasa" value
 * @method NotDep    setMoneda()     Sets the current record's "moneda" value
 * @method NotDep    setCtaContab()  Sets the current record's "cta_contab" value
 * @method NotDep    setSeriales()   Sets the current record's "seriales" value
 * @method NotDep    setTasag()      Sets the current record's "tasag" value
 * @method NotDep    setTasag10()    Sets the current record's "tasag10" value
 * @method NotDep    setTasag20()    Sets the current record's "tasag20" value
 * @method NotDep    setCampo1()     Sets the current record's "campo1" value
 * @method NotDep    setCampo2()     Sets the current record's "campo2" value
 * @method NotDep    setCampo3()     Sets the current record's "campo3" value
 * @method NotDep    setCampo4()     Sets the current record's "campo4" value
 * @method NotDep    setCampo5()     Sets the current record's "campo5" value
 * @method NotDep    setCampo6()     Sets the current record's "campo6" value
 * @method NotDep    setCampo7()     Sets the current record's "campo7" value
 * @method NotDep    setCampo8()     Sets the current record's "campo8" value
 * @method NotDep    setCoUsIn()     Sets the current record's "co_us_in" value
 * @method NotDep    setFeUsIn()     Sets the current record's "fe_us_in" value
 * @method NotDep    setCoUsMo()     Sets the current record's "co_us_mo" value
 * @method NotDep    setFeUsMo()     Sets the current record's "fe_us_mo" value
 * @method NotDep    setCoUsEl()     Sets the current record's "co_us_el" value
 * @method NotDep    setFeUsEl()     Sets the current record's "fe_us_el" value
 * @method NotDep    setRevisado()   Sets the current record's "revisado" value
 * @method NotDep    setTrasnfe()    Sets the current record's "trasnfe" value
 * @method NotDep    setCoSucu()     Sets the current record's "co_sucu" value
 * @method NotDep    setRowguid()    Sets the current record's "rowguid" value
 * @method NotDep    setMonIlc()     Sets the current record's "mon_ilc" value
 * @method NotDep    setOtros1()     Sets the current record's "otros1" value
 * @method NotDep    setOtros2()     Sets the current record's "otros2" value
 * @method NotDep    setOtros3()     Sets the current record's "otros3" value
 * @method NotDep    setAux01()      Sets the current record's "aux01" value
 * @method NotDep    setAux02()      Sets the current record's "aux02" value
 * @method NotDep    setSalestax()   Sets the current record's "salestax" value
 * @method NotDep    setOrigen()     Sets the current record's "origen" value
 * @method NotDep    setOrigenD()    Sets the current record's "origen_d" value
 * @method NotDep    setTelefono()   Sets the current record's "telefono" value
 * @method NotDep    setStaProd()    Sets the current record's "sta_prod" value
 * @method NotDep    setClientes()   Sets the current record's "Clientes" value
 * @method NotDep    setVendedor()   Sets the current record's "Vendedor" value
 * @method NotDep    setTranspor()   Sets the current record's "Transpor" value
 * @method NotDep    setCondicio()   Sets the current record's "Condicio" value
 * @method NotDep    setMoneda()     Sets the current record's "Moneda" value
 * @method NotDep    setAlmacen()    Sets the current record's "Almacen" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseNotDep extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('not_dep');
