...
Doctrine_Manager::getInstance()->bindComponent('RengFai', 'profit');
 ...
 * @method RengFai setImpNum()   Sets the current record's "imp_num" value
 * @method RengFai setRengNum()  Sets the current record's "reng_num" value
 * @method RengFai setFactNum()  Sets the current record's "fact_num" value
 * @method RengFai setTotNeto()  Sets the current record's "tot_neto" value
 * @method RengFai setDescrip()  Sets the current record's "descrip" value
 * @method RengFai setRowguid()  Sets the current record's "rowguid" value
 * @method RengFai setAux01()    Sets the current record's "aux01" value
 * @method RengFai setAux02()    Sets the current record's "aux02" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengFai extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_fai');
