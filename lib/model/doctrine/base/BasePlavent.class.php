...
Doctrine_Manager::getInstance()->bindComponent('Plavent', 'profit');
 ...
 * @method Plavent   setFactNum()    Sets the current record's "fact_num" value
 * @method Plavent   setContrib()    Sets the current record's "contrib" value
 * @method Plavent   setNombre()     Sets the current record's "nombre" value
 * @method Plavent   setRif()        Sets the current record's "rif" value
 * @method Plavent   setNit()        Sets the current record's "nit" value
 * @method Plavent   setStatus()     Sets the current record's "status" value
 * @method Plavent   setComentario() Sets the current record's "comentario" value
 * @method Plavent   setDescrip()    Sets the current record's "descrip" value
 * @method Plavent   setSaldo()      Sets the current record's "saldo" value
 * @method Plavent   setFecEmis()    Sets the current record's "fec_emis" value
 * @method Plavent   setFecVenc()    Sets the current record's "fec_venc" value
 * @method Plavent   setCoCli()      Sets the current record's "co_cli" value
 * @method Plavent   setCoVen()      Sets the current record's "co_ven" value
 * @method Plavent   setCoTran()     Sets the current record's "co_tran" value
 * @method Plavent   setDirEnt()     Sets the current record's "dir_ent" value
 * @method Plavent   setFormaPag()   Sets the current record's "forma_pag" value
 * @method Plavent   setTotBruto()   Sets the current record's "tot_bruto" value
 * @method Plavent   setTotNeto()    Sets the current record's "tot_neto" value
 * @method Plavent   setGlobDesc()   Sets the current record's "glob_desc" value
 * @method Plavent   setTotReca()    Sets the current record's "tot_reca" value
 * @method Plavent   setPorcGdesc()  Sets the current record's "porc_gdesc" value
 * @method Plavent   setPorcReca()   Sets the current record's "porc_reca" value
 * @method Plavent   setTotalUc()    Sets the current record's "total_uc" value
 * @method Plavent   setTotalCp()    Sets the current record's "total_cp" value
 * @method Plavent   setTotFlete()   Sets the current record's "tot_flete" value
 * @method Plavent   setMontoDev()   Sets the current record's "monto_dev" value
 * @method Plavent   setTotklu()     Sets the current record's "totklu" value
 * @method Plavent   setAnulada()    Sets the current record's "anulada" value
 * @method Plavent   setImpresa()    Sets the current record's "impresa" value
 * @method Plavent   setIva()        Sets the current record's "iva" value
 * @method Plavent   setIvaDev()     Sets the current record's "iva_dev" value
 * @method Plavent   setFeccom()     Sets the current record's "feccom" value
 * @method Plavent   setNumcom()     Sets the current record's "numcom" value
 * @method Plavent   setTasa()       Sets the current record's "tasa" value
 * @method Plavent   setMoneda()     Sets the current record's "moneda" value
 * @method Plavent   setCtaContab()  Sets the current record's "cta_contab" value
 * @method Plavent   setSeriales()   Sets the current record's "seriales" value
 * @method Plavent   setTasag()      Sets the current record's "tasag" value
 * @method Plavent   setTasag10()    Sets the current record's "tasag10" value
 * @method Plavent   setTasag20()    Sets the current record's "tasag20" value
 * @method Plavent   setCampo1()     Sets the current record's "campo1" value
 * @method Plavent   setCampo2()     Sets the current record's "campo2" value
 * @method Plavent   setCampo3()     Sets the current record's "campo3" value
 * @method Plavent   setCampo4()     Sets the current record's "campo4" value
 * @method Plavent   setCampo5()     Sets the current record's "campo5" value
 * @method Plavent   setCampo6()     Sets the current record's "campo6" value
 * @method Plavent   setCampo7()     Sets the current record's "campo7" value
 * @method Plavent   setCampo8()     Sets the current record's "campo8" value
 * @method Plavent   setCoUsIn()     Sets the current record's "co_us_in" value
 * @method Plavent   setFeUsIn()     Sets the current record's "fe_us_in" value
 * @method Plavent   setCoUsMo()     Sets the current record's "co_us_mo" value
 * @method Plavent   setFeUsMo()     Sets the current record's "fe_us_mo" value
 * @method Plavent   setCoUsEl()     Sets the current record's "co_us_el" value
 * @method Plavent   setFeUsEl()     Sets the current record's "fe_us_el" value
 * @method Plavent   setRevisado()   Sets the current record's "revisado" value
 * @method Plavent   setTrasnfe()    Sets the current record's "trasnfe" value
 * @method Plavent   setCoSucu()     Sets the current record's "co_sucu" value
 * @method Plavent   setRowguid()    Sets the current record's "rowguid" value
 * @method Plavent   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method Plavent   setOtros1()     Sets the current record's "otros1" value
 * @method Plavent   setOtros2()     Sets the current record's "otros2" value
 * @method Plavent   setOtros3()     Sets the current record's "otros3" value
 * @method Plavent   setDisCen()     Sets the current record's "dis_cen" value
 * @method Plavent   setAux01()      Sets the current record's "aux01" value
 * @method Plavent   setAux02()      Sets the current record's "aux02" value
 * @method Plavent   setSalestax()   Sets the current record's "salestax" value
 * @method Plavent   setOrigen()     Sets the current record's "origen" value
 * @method Plavent   setOrigenD()    Sets the current record's "origen_d" value
 * @method Plavent   setTelefono()   Sets the current record's "telefono" value
 * @method Plavent   setStaProd()    Sets the current record's "sta_prod" value
 * @method Plavent   setClientes()   Sets the current record's "Clientes" value
 * @method Plavent   setVendedor()   Sets the current record's "Vendedor" value
 * @method Plavent   setTranspor()   Sets the current record's "Transpor" value
 * @method Plavent   setCondicio()   Sets the current record's "Condicio" value
 * @method Plavent   setMoneda()     Sets the current record's "Moneda" value
 * @method Plavent   setAlmacen()    Sets the current record's "Almacen" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BasePlavent extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('plavent');
        ...
        $this->hasColumn('campo8', 'string', 50, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'notnull' => true,
