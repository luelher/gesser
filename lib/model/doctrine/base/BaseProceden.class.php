...
Doctrine_Manager::getInstance()->bindComponent('Proceden', 'profit');
 ...
 * 
 * @method string              getCodProc()  Returns the current record's "cod_proc" value
 * @method string              getDesProc()  Returns the current record's "des_proc" value
 ...
 * @method Proceden            setCodProc()  Sets the current record's "cod_proc" value
 * @method Proceden            setDesProc()  Sets the current record's "des_proc" value
 * @method Proceden            setCampo1()   Sets the current record's "campo1" value
 * @method Proceden            setCampo2()   Sets the current record's "campo2" value
 * @method Proceden            setCampo3()   Sets the current record's "campo3" value
 * @method Proceden            setCampo4()   Sets the current record's "campo4" value
 * @method Proceden            setCoUsIn()   Sets the current record's "co_us_in" value
 * @method Proceden            setFeUsIn()   Sets the current record's "fe_us_in" value
 * @method Proceden            setCoUsMo()   Sets the current record's "co_us_mo" value
 * @method Proceden            setFeUsMo()   Sets the current record's "fe_us_mo" value
 * @method Proceden            setCoUsEl()   Sets the current record's "co_us_el" value
 * @method Proceden            setFeUsEl()   Sets the current record's "fe_us_el" value
 * @method Proceden            setRevisado() Sets the current record's "revisado" value
 * @method Proceden            setTrasnfe()  Sets the current record's "trasnfe" value
 * @method Proceden            setCoSucu()   Sets the current record's "co_sucu" value
 * @method Proceden            setRowguid()  Sets the current record's "rowguid" value
 * @method Proceden            setArt()      Sets the current record's "Art" collection
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseProceden extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('proceden');
        $this->hasColumn('cod_proc', 'string', 6, array(
             'type' => 'string',
             'fixed' => 1,
             'unsigned' => false,
             'primary' => true,
        ...
        $this->hasColumn('des_proc', 'string', 60, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'notnull' => true,
