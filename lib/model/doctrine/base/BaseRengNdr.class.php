...
Doctrine_Manager::getInstance()->bindComponent('RengNdr', 'profit');
 ...
 * @method RengNdr   setFactNum()    Sets the current record's "fact_num" value
 * @method RengNdr   setRengNum()    Sets the current record's "reng_num" value
 * @method RengNdr   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengNdr   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengNdr   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengNdr   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengNdr   setCoArt()      Sets the current record's "co_art" value
 * @method RengNdr   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengNdr   setTotalArt()   Sets the current record's "total_art" value
 * @method RengNdr   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengNdr   setPendiente()  Sets the current record's "pendiente" value
 * @method RengNdr   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengNdr   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengNdr   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengNdr   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengNdr   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengNdr   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengNdr   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengNdr   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengNdr   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengNdr   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengNdr   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengNdr   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengNdr   setAnulado()    Sets the current record's "anulado" value
 * @method RengNdr   setDesArt()     Sets the current record's "des_art" value
 * @method RengNdr   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengNdr   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengNdr   setComentario() Sets the current record's "comentario" value
 * @method RengNdr   setRowguid()    Sets the current record's "rowguid" value
 * @method RengNdr   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengNdr   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengNdr   setOtros()      Sets the current record's "otros" value
 * @method RengNdr   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengNdr   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengNdr   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengNdr   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengNdr   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengNdr   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengNdr   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengNdr   setAux01()      Sets the current record's "aux01" value
 * @method RengNdr   setAux02()      Sets the current record's "aux02" value
 * @method RengNdr   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengNdr   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengNdr   setArt()        Sets the current record's "Art" value
 * @method RengNdr   setSubAlma()    Sets the current record's "SubAlma" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengNdr extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_ndr');
