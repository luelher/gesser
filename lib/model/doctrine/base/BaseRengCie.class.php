...
Doctrine_Manager::getInstance()->bindComponent('RengCie', 'profit');
 ...
 * @method Spcierre  getSpcierre()   Returns the current record's "Spcierre" value
 * @method Art       getArt()        Returns the current record's "Art" value
 * @method RengCie   setEntNum()     Sets the current record's "ent_num" value
 * @method RengCie   setRengNum()    Sets the current record's "reng_num" value
 * @method RengCie   setCoArt()      Sets the current record's "co_art" value
 * @method RengCie   setTotalArt()   Sets the current record's "total_art" value
 * @method RengCie   setCoUni()      Sets the current record's "co_uni" value
 * @method RengCie   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengCie   setRowguid()    Sets the current record's "rowguid" value
 * @method RengCie   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengCie   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengCie   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengCie   setNumcom()     Sets the current record's "numcom" value
 * @method RengCie   setFeccom()     Sets the current record's "feccom" value
 * @method RengCie   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengCie   setSpcierre()   Sets the current record's "Spcierre" value
 * @method RengCie   setArt()        Sets the current record's "Art" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengCie extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_cie');
