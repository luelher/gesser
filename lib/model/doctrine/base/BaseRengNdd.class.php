...
Doctrine_Manager::getInstance()->bindComponent('RengNdd', 'profit');
 ...
 * @method RengNdd   setFactNum()    Sets the current record's "fact_num" value
 * @method RengNdd   setRengNum()    Sets the current record's "reng_num" value
 * @method RengNdd   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengNdd   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengNdd   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengNdd   setCoArt()      Sets the current record's "co_art" value
 * @method RengNdd   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengNdd   setTotalArt()   Sets the current record's "total_art" value
 * @method RengNdd   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengNdd   setPendiente()  Sets the current record's "pendiente" value
 * @method RengNdd   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengNdd   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengNdd   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengNdd   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengNdd   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengNdd   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengNdd   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengNdd   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengNdd   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengNdd   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengNdd   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengNdd   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengNdd   setAnulado()    Sets the current record's "anulado" value
 * @method RengNdd   setDesArt()     Sets the current record's "des_art" value
 * @method RengNdd   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengNdd   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengNdd   setComentario() Sets the current record's "comentario" value
 * @method RengNdd   setRowguid()    Sets the current record's "rowguid" value
 * @method RengNdd   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengNdd   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengNdd   setOtros()      Sets the current record's "otros" value
 * @method RengNdd   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengNdd   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengNdd   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengNdd   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengNdd   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengNdd   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengNdd   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengNdd   setAux01()      Sets the current record's "aux01" value
 * @method RengNdd   setAux02()      Sets the current record's "aux02" value
 * @method RengNdd   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengNdd   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengNdd   setArt()        Sets the current record's "Art" value
 * @method RengNdd   setSubAlma()    Sets the current record's "SubAlma" value
 * @method RengNdd   setTabulado()   Sets the current record's "Tabulado" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengNdd extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_ndd');
