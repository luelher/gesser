...
Doctrine_Manager::getInstance()->bindComponent('RengPed', 'profit');
 ...
 * @method RengPed   setFactNum()    Sets the current record's "fact_num" value
 * @method RengPed   setRengNum()    Sets the current record's "reng_num" value
 * @method RengPed   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengPed   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengPed   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengPed   setCoArt()      Sets the current record's "co_art" value
 * @method RengPed   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengPed   setTotalArt()   Sets the current record's "total_art" value
 * @method RengPed   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengPed   setPendiente()  Sets the current record's "pendiente" value
 * @method RengPed   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengPed   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengPed   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengPed   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengPed   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengPed   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengPed   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengPed   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengPed   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengPed   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengPed   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengPed   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengPed   setAnulado()    Sets the current record's "anulado" value
 * @method RengPed   setDesArt()     Sets the current record's "des_art" value
 * @method RengPed   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengPed   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengPed   setComentario() Sets the current record's "comentario" value
 * @method RengPed   setRowguid()    Sets the current record's "rowguid" value
 * @method RengPed   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengPed   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengPed   setOtros()      Sets the current record's "otros" value
 * @method RengPed   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengPed   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengPed   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengPed   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengPed   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengPed   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengPed   setSerialp()    Sets the current record's "serialp" value
 * @method RengPed   setValido()     Sets the current record's "valido" value
 * @method RengPed   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengPed   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengPed   setAux01()      Sets the current record's "aux01" value
 * @method RengPed   setAux02()      Sets the current record's "aux02" value
 * @method RengPed   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengPed   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengPed   setArt()        Sets the current record's "Art" value
 * @method RengPed   setSubAlma()    Sets the current record's "SubAlma" value
 * @method RengPed   setTabulado()   Sets the current record's "Tabulado" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengPed extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_ped');
