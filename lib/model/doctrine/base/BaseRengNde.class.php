...
Doctrine_Manager::getInstance()->bindComponent('RengNde', 'profit');
 ...
 * @method RengNde   setFactNum()    Sets the current record's "fact_num" value
 * @method RengNde   setRengNum()    Sets the current record's "reng_num" value
 * @method RengNde   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengNde   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengNde   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengNde   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengNde   setCoArt()      Sets the current record's "co_art" value
 * @method RengNde   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengNde   setTotalArt()   Sets the current record's "total_art" value
 * @method RengNde   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengNde   setPendiente()  Sets the current record's "pendiente" value
 * @method RengNde   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengNde   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengNde   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengNde   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengNde   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengNde   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengNde   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengNde   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengNde   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengNde   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengNde   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengNde   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengNde   setAnulado()    Sets the current record's "anulado" value
 * @method RengNde   setDesArt()     Sets the current record's "des_art" value
 * @method RengNde   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengNde   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengNde   setComentario() Sets the current record's "comentario" value
 * @method RengNde   setRowguid()    Sets the current record's "rowguid" value
 * @method RengNde   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengNde   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengNde   setOtros()      Sets the current record's "otros" value
 * @method RengNde   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengNde   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengNde   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengNde   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengNde   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengNde   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengNde   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengNde   setAux01()      Sets the current record's "aux01" value
 * @method RengNde   setAux02()      Sets the current record's "aux02" value
 * @method RengNde   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengNde   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengNde   setArt()        Sets the current record's "Art" value
 * @method RengNde   setSubAlma()    Sets the current record's "SubAlma" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengNde extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_nde');
