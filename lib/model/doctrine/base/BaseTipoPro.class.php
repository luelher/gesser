...
Doctrine_Manager::getInstance()->bindComponent('TipoPro', 'profit');
 ...
 * 
 * @method string              getTipPro()   Returns the current record's "tip_pro" value
 ...
 * @method TipoPro             setTipPro()   Sets the current record's "tip_pro" value
 * @method TipoPro             setDesTipo()  Sets the current record's "des_tipo" value
 * @method TipoPro             setCampo1()   Sets the current record's "campo1" value
 * @method TipoPro             setCampo2()   Sets the current record's "campo2" value
 * @method TipoPro             setCampo3()   Sets the current record's "campo3" value
 * @method TipoPro             setCampo4()   Sets the current record's "campo4" value
 * @method TipoPro             setCoUsIn()   Sets the current record's "co_us_in" value
 * @method TipoPro             setFeUsIn()   Sets the current record's "fe_us_in" value
 * @method TipoPro             setCoUsMo()   Sets the current record's "co_us_mo" value
 * @method TipoPro             setFeUsMo()   Sets the current record's "fe_us_mo" value
 * @method TipoPro             setCoUsEl()   Sets the current record's "co_us_el" value
 * @method TipoPro             setFeUsEl()   Sets the current record's "fe_us_el" value
 * @method TipoPro             setRevisado() Sets the current record's "revisado" value
 * @method TipoPro             setTrasnfe()  Sets the current record's "trasnfe" value
 * @method TipoPro             setCoSucu()   Sets the current record's "co_sucu" value
 * @method TipoPro             setRowguid()  Sets the current record's "rowguid" value
 * @method TipoPro             setProv()     Sets the current record's "Prov" collection
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseTipoPro extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('tipo_pro');
        $this->hasColumn('tip_pro', 'string', 6, array(
             'type' => 'string',
             'fixed' => 1,
             'unsigned' => false,
             'primary' => true,
