...
Doctrine_Manager::getInstance()->bindComponent('Spmenenc', 'profit');
 ...
 * @property string $des_men
 * @property timestamp $fec_emis
 * @property boolean $comprom
 ...
 * @property Doctrine_Collection $RengMen
 * 
 * @method integer             getMenNum()    Returns the current record's "men_num" value
 * @method string              getDesMen()    Returns the current record's "des_men" value
 * @method timestamp           getFecEmis()   Returns the current record's "fec_emis" value
 * @method boolean             getComprom()   Returns the current record's "comprom" value
 ...
 * @method Doctrine_Collection getRengMen()   Returns the current record's "RengMen" collection
 * @method Spmenenc            setMenNum()    Sets the current record's "men_num" value
 * @method Spmenenc            setDesMen()    Sets the current record's "des_men" value
 * @method Spmenenc            setFecEmis()   Sets the current record's "fec_emis" value
 * @method Spmenenc            setComprom()   Sets the current record's "comprom" value
 * @method Spmenenc            setProcesado() Sets the current record's "procesado" value
 * @method Spmenenc            setCampo1()    Sets the current record's "campo1" value
 * @method Spmenenc            setCampo2()    Sets the current record's "campo2" value
 * @method Spmenenc            setCampo3()    Sets the current record's "campo3" value
 * @method Spmenenc            setCampo4()    Sets the current record's "campo4" value
 * @method Spmenenc            setCampo5()    Sets the current record's "campo5" value
 * @method Spmenenc            setCampo6()    Sets the current record's "campo6" value
 * @method Spmenenc            setCampo7()    Sets the current record's "campo7" value
 * @method Spmenenc            setCampo8()    Sets the current record's "campo8" value
 * @method Spmenenc            setCoUsIn()    Sets the current record's "co_us_in" value
 * @method Spmenenc            setFeUsIn()    Sets the current record's "fe_us_in" value
 * @method Spmenenc            setCoUsMo()    Sets the current record's "co_us_mo" value
 * @method Spmenenc            setFeUsMo()    Sets the current record's "fe_us_mo" value
 * @method Spmenenc            setCoUsEl()    Sets the current record's "co_us_el" value
 * @method Spmenenc            setFeUsEl()    Sets the current record's "fe_us_el" value
 * @method Spmenenc            setRevisado()  Sets the current record's "revisado" value
 * @method Spmenenc            setTrasnfe()   Sets the current record's "trasnfe" value
 * @method Spmenenc            setCoSucu()    Sets the current record's "co_sucu" value
 * @method Spmenenc            setRowguid()   Sets the current record's "rowguid" value
 * @method Spmenenc            setRengMen()   Sets the current record's "RengMen" collection
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseSpmenenc extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('spmenenc');
        ...
        $this->hasColumn('des_men', 'string', 60, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'notnull' => true,
        ...
        $this->hasColumn('comprom', 'boolean', 1, array(
             'type' => 'boolean',
             'fixed' => 0,
             'unsigned' => false,
             'notnull' => true,
        ...
        $this->hasColumn('procesado', 'boolean', 1, array(
             'type' => 'boolean',
             'fixed' => 0,
             'unsigned' => false,
             'notnull' => true,
