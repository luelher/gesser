...
Doctrine_Manager::getInstance()->bindComponent('RengCac', 'profit');
 ...
 * @method RengCac   setFactNum()    Sets the current record's "fact_num" value
 * @method RengCac   setRengNum()    Sets the current record's "reng_num" value
 * @method RengCac   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengCac   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengCac   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengCac   setCoArt()      Sets the current record's "co_art" value
 * @method RengCac   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengCac   setTotalArt()   Sets the current record's "total_art" value
 * @method RengCac   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengCac   setPendiente()  Sets the current record's "pendiente" value
 * @method RengCac   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengCac   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengCac   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengCac   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengCac   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengCac   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengCac   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengCac   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengCac   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengCac   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengCac   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengCac   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengCac   setAnulado()    Sets the current record's "anulado" value
 * @method RengCac   setDesArt()     Sets the current record's "des_art" value
 * @method RengCac   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengCac   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengCac   setComentario() Sets the current record's "comentario" value
 * @method RengCac   setRowguid()    Sets the current record's "rowguid" value
 * @method RengCac   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengCac   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengCac   setOtros()      Sets the current record's "otros" value
 * @method RengCac   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengCac   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengCac   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengCac   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengCac   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengCac   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengCac   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengCac   setAux01()      Sets the current record's "aux01" value
 * @method RengCac   setAux02()      Sets the current record's "aux02" value
 * @method RengCac   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengCac   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengCac   setArt()        Sets the current record's "Art" value
 * @method RengCac   setSubAlma()    Sets the current record's "SubAlma" value
 * @method RengCac   setTabulado()   Sets the current record's "Tabulado" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengCac extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_cac');
