...
Doctrine_Manager::getInstance()->bindComponent('RengDvc', 'profit');
 ...
 * @method RengDvc   setFactNum()    Sets the current record's "fact_num" value
 * @method RengDvc   setRengNum()    Sets the current record's "reng_num" value
 * @method RengDvc   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengDvc   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengDvc   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengDvc   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengDvc   setCoArt()      Sets the current record's "co_art" value
 * @method RengDvc   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengDvc   setTotalArt()   Sets the current record's "total_art" value
 * @method RengDvc   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengDvc   setPendiente()  Sets the current record's "pendiente" value
 * @method RengDvc   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengDvc   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengDvc   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengDvc   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengDvc   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengDvc   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengDvc   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengDvc   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengDvc   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengDvc   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengDvc   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengDvc   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengDvc   setAnulado()    Sets the current record's "anulado" value
 * @method RengDvc   setDesArt()     Sets the current record's "des_art" value
 * @method RengDvc   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengDvc   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengDvc   setComentario() Sets the current record's "comentario" value
 * @method RengDvc   setRowguid()    Sets the current record's "rowguid" value
 * @method RengDvc   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengDvc   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengDvc   setOtros()      Sets the current record's "otros" value
 * @method RengDvc   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengDvc   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengDvc   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengDvc   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengDvc   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengDvc   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengDvc   setTipoPrec()   Sets the current record's "tipo_prec" value
 * @method RengDvc   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengDvc   setAux01()      Sets the current record's "aux01" value
 * @method RengDvc   setAux02()      Sets the current record's "aux02" value
 * @method RengDvc   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengDvc   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengDvc   setArt()        Sets the current record's "Art" value
 * @method RengDvc   setSubAlma()    Sets the current record's "SubAlma" value
 * @method RengDvc   setTabulado()   Sets the current record's "Tabulado" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengDvc extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_dvc');
