...
Doctrine_Manager::getInstance()->bindComponent('RengPlc', 'profit');
 ...
 * @method RengPlc   setFactNum()    Sets the current record's "fact_num" value
 * @method RengPlc   setRengNum()    Sets the current record's "reng_num" value
 * @method RengPlc   setTipoDoc()    Sets the current record's "tipo_doc" value
 * @method RengPlc   setRengDoc()    Sets the current record's "reng_doc" value
 * @method RengPlc   setNumDoc()     Sets the current record's "num_doc" value
 * @method RengPlc   setCoArt()      Sets the current record's "co_art" value
 * @method RengPlc   setCoAlma()     Sets the current record's "co_alma" value
 * @method RengPlc   setTotalArt()   Sets the current record's "total_art" value
 * @method RengPlc   setStotalArt()  Sets the current record's "stotal_art" value
 * @method RengPlc   setPendiente()  Sets the current record's "pendiente" value
 * @method RengPlc   setUniVenta()   Sets the current record's "uni_venta" value
 * @method RengPlc   setPrecVta()    Sets the current record's "prec_vta" value
 * @method RengPlc   setPorcDesc()   Sets the current record's "porc_desc" value
 * @method RengPlc   setTipoImp()    Sets the current record's "tipo_imp" value
 * @method RengPlc   setRengNeto()   Sets the current record's "reng_neto" value
 * @method RengPlc   setCosProUn()   Sets the current record's "cos_pro_un" value
 * @method RengPlc   setUltCosUn()   Sets the current record's "ult_cos_un" value
 * @method RengPlc   setUltCosOm()   Sets the current record's "ult_cos_om" value
 * @method RengPlc   setCosProOm()   Sets the current record's "cos_pro_om" value
 * @method RengPlc   setTotalDev()   Sets the current record's "total_dev" value
 * @method RengPlc   setMontoDev()   Sets the current record's "monto_dev" value
 * @method RengPlc   setPrecVta2()   Sets the current record's "prec_vta2" value
 * @method RengPlc   setAnulado()    Sets the current record's "anulado" value
 * @method RengPlc   setDesArt()     Sets the current record's "des_art" value
 * @method RengPlc   setSeleccion()  Sets the current record's "seleccion" value
 * @method RengPlc   setCantImp()    Sets the current record's "cant_imp" value
 * @method RengPlc   setComentario() Sets the current record's "comentario" value
 * @method RengPlc   setRowguid()    Sets the current record's "rowguid" value
 * @method RengPlc   setTotalUni()   Sets the current record's "total_uni" value
 * @method RengPlc   setMonIlc()     Sets the current record's "mon_ilc" value
 * @method RengPlc   setOtros()      Sets the current record's "otros" value
 * @method RengPlc   setNroLote()    Sets the current record's "nro_lote" value
 * @method RengPlc   setFecLote()    Sets the current record's "fec_lote" value
 * @method RengPlc   setPendiente2() Sets the current record's "pendiente2" value
 * @method RengPlc   setTipoDoc2()   Sets the current record's "tipo_doc2" value
 * @method RengPlc   setRengDoc2()   Sets the current record's "reng_doc2" value
 * @method RengPlc   setNumDoc2()    Sets the current record's "num_doc2" value
 * @method RengPlc   setCoAlma2()    Sets the current record's "co_alma2" value
 * @method RengPlc   setDisCen()     Sets the current record's "dis_cen" value
 * @method RengPlc   setAux01()      Sets the current record's "aux01" value
 * @method RengPlc   setAux02()      Sets the current record's "aux02" value
 * @method RengPlc   setCantProd()   Sets the current record's "cant_prod" value
 * @method RengPlc   setImpProd()    Sets the current record's "imp_prod" value
 * @method RengPlc   setArt()        Sets the current record's "Art" value
 * @method RengPlc   setSubAlma()    Sets the current record's "SubAlma" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseRengPlc extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reng_plc');
