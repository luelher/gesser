...
Doctrine_Manager::getInstance()->bindComponent('NotEnt', 'profit');
 ...
 * @method NotEnt    setFactNum()    Sets the current record's "fact_num" value
 * @method NotEnt    setContrib()    Sets the current record's "contrib" value
 * @method NotEnt    setNombre()     Sets the current record's "nombre" value
 * @method NotEnt    setRif()        Sets the current record's "rif" value
 * @method NotEnt    setNit()        Sets the current record's "nit" value
 * @method NotEnt    setStatus()     Sets the current record's "status" value
 * @method NotEnt    setComentario() Sets the current record's "comentario" value
 * @method NotEnt    setDescrip()    Sets the current record's "descrip" value
 * @method NotEnt    setSaldo()      Sets the current record's "saldo" value
 * @method NotEnt    setFecEmis()    Sets the current record's "fec_emis" value
 * @method NotEnt    setFecVenc()    Sets the current record's "fec_venc" value
 * @method NotEnt    setCoCli()      Sets the current record's "co_cli" value
 * @method NotEnt    setCoVen()      Sets the current record's "co_ven" value
 * @method NotEnt    setCoTran()     Sets the current record's "co_tran" value
 * @method NotEnt    setDirEnt()     Sets the current record's "dir_ent" value
 * @method NotEnt    setFormaPag()   Sets the current record's "forma_pag" value
 * @method NotEnt    setTotBruto()   Sets the current record's "tot_bruto" value
 * @method NotEnt    setTotNeto()    Sets the current record's "tot_neto" value
 * @method NotEnt    setGlobDesc()   Sets the current record's "glob_desc" value
 * @method NotEnt    setTotReca()    Sets the current record's "tot_reca" value
 * @method NotEnt    setPorcGdesc()  Sets the current record's "porc_gdesc" value
 * @method NotEnt    setPorcReca()   Sets the current record's "porc_reca" value
 * @method NotEnt    setTotalUc()    Sets the current record's "total_uc" value
 * @method NotEnt    setTotalCp()    Sets the current record's "total_cp" value
 * @method NotEnt    setTotFlete()   Sets the current record's "tot_flete" value
 * @method NotEnt    setMontoDev()   Sets the current record's "monto_dev" value
 * @method NotEnt    setTotklu()     Sets the current record's "totklu" value
 * @method NotEnt    setAnulada()    Sets the current record's "anulada" value
 * @method NotEnt    setImpresa()    Sets the current record's "impresa" value
 * @method NotEnt    setIva()        Sets the current record's "iva" value
 * @method NotEnt    setIvaDev()     Sets the current record's "iva_dev" value
 * @method NotEnt    setFeccom()     Sets the current record's "feccom" value
 * @method NotEnt    setNumcom()     Sets the current record's "numcom" value
 * @method NotEnt    setTasa()       Sets the current record's "tasa" value
 * @method NotEnt    setMoneda()     Sets the current record's "moneda" value
 * @method NotEnt    setCtaContab()  Sets the current record's "cta_contab" value
 * @method NotEnt    setSeriales()   Sets the current record's "seriales" value
 * @method NotEnt    setTasag()      Sets the current record's "tasag" value
 * @method NotEnt    setTasag10()    Sets the current record's "tasag10" value
 * @method NotEnt    setTasag20()    Sets the current record's "tasag20" value
 * @method NotEnt    setCampo1()     Sets the current record's "campo1" value
 * @method NotEnt    setCampo2()     Sets the current record's "campo2" value
 * @method NotEnt    setCampo3()     Sets the current record's "campo3" value
 * @method NotEnt    setCampo4()     Sets the current record's "campo4" value
 * @method NotEnt    setCampo5()     Sets the current record's "campo5" value
 * @method NotEnt    setCampo6()     Sets the current record's "campo6" value
 * @method NotEnt    setCampo7()     Sets the current record's "campo7" value
 * @method NotEnt    setCampo8()     Sets the current record's "campo8" value
 * @method NotEnt    setCoUsIn()     Sets the current record's "co_us_in" value
 * @method NotEnt    setFeUsIn()     Sets the current record's "fe_us_in" value
 * @method NotEnt    setCoUsMo()     Sets the current record's "co_us_mo" value
 * @method NotEnt    setFeUsMo()     Sets the current record's "fe_us_mo" value
 * @method NotEnt    setCoUsEl()     Sets the current record's "co_us_el" value
 * @method NotEnt    setFeUsEl()     Sets the current record's "fe_us_el" value
 * @method NotEnt    setRevisado()   Sets the current record's "revisado" value
 * @method NotEnt    setTrasnfe()    Sets the current record's "trasnfe" value
 * @method NotEnt    setCoSucu()     Sets the current record's "co_sucu" value
 * @method NotEnt    setRowguid()    Sets the current record's "rowguid" value
 * @method NotEnt    setNumcon()     Sets the current record's "numcon" value
 * @method NotEnt    setMonIlc()     Sets the current record's "mon_ilc" value
 * @method NotEnt    setOtros1()     Sets the current record's "otros1" value
 * @method NotEnt    setOtros2()     Sets the current record's "otros2" value
 * @method NotEnt    setOtros3()     Sets the current record's "otros3" value
 * @method NotEnt    setDisCen()     Sets the current record's "dis_cen" value
 * @method NotEnt    setAux01()      Sets the current record's "aux01" value
 * @method NotEnt    setAux02()      Sets the current record's "aux02" value
 * @method NotEnt    setSalestax()   Sets the current record's "salestax" value
 * @method NotEnt    setOrigen()     Sets the current record's "origen" value
 * @method NotEnt    setOrigenD()    Sets the current record's "origen_d" value
 * @method NotEnt    setTelefono()   Sets the current record's "telefono" value
 * @method NotEnt    setStaProd()    Sets the current record's "sta_prod" value
 * @method NotEnt    setClientes()   Sets the current record's "Clientes" value
 * @method NotEnt    setVendedor()   Sets the current record's "Vendedor" value
 * @method NotEnt    setTranspor()   Sets the current record's "Transpor" value
 * @method NotEnt    setCondicio()   Sets the current record's "Condicio" value
 * @method NotEnt    setMoneda()     Sets the current record's "Moneda" value
 * @method NotEnt    setAlmacen()    Sets the current record's "Almacen" value
 * 
 * @package    gesser
 * @subpackage model
 ...
 */
abstract class BaseNotEnt extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('not_ent');
