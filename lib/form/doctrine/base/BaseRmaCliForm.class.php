...
/**
 * RmaCli form base class.
 *
 * @method RmaCli getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseRmaCliForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rma_cli[%s]');
