...
/**
 * Ambtras form base class.
 *
 * @method Ambtras getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseAmbtrasForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'amb_usua'   => new sfWidgetFormInputHidden(),
      'tras_num'   => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'tras_num'   => new sfValidatorBoolean(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ambtras[%s]');
