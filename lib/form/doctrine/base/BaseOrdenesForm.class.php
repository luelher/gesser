...
/**
 * Ordenes form base class.
 *
 * @method Ordenes getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseOrdenesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'inf_imp'    => new sfWidgetFormTextarea(),
    ));
    ...
    $this->setValidators(array(
      ...
      'inf_imp'    => new sfValidatorString(array('max_length' => 2147483647, 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('ordenes[%s]');
