...
/**
 * MovBan form base class.
 *
 * @method MovBan getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseMovBanForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'mov_num'    => new sfWidgetFormInputHidden(),
      'codigo'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Cuentas'), 'add_empty' => false)),
      ...
      'fec_con'    => new sfWidgetFormDateTime(),
      ...
      'comisiontv' => new sfWidgetFormInputText(),
      'impuestotv' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'codigo'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Cuentas'), 'required' => false)),
      ...
      'fec_con'    => new sfValidatorDateTime(array('required' => false)),
      ...
      'comisiontv' => new sfValidatorNumber(array('required' => false)),
      'impuestotv' => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('mov_ban[%s]');
