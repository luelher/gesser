...
/**
 * RengNdr form base class.
 *
 * @method RengNdr getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseRengNdrForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reng_ndr[%s]');
