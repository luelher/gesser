 ...
 *
 * @method CatArt getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseCatArtForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'co_cat'   => new sfWidgetFormInputHidden(),
      'cat_des'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      'co_cat'   => new sfValidatorChoice(array('choices' => array($this->getObject()->get('co_cat')), 'empty_value' => $this->getObject()->get('co_cat'), 'required' => false)),
      'cat_des'  => new sfValidatorString(array('max_length' => 60, 'required' => false)),
