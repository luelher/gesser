...
/**
 * Ambentre form base class.
 *
 * @method Ambentre getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseAmbentreForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'co_es_mo'   => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'co_es_mo'   => new sfValidatorString(array('max_length' => 4, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ambentre[%s]');
