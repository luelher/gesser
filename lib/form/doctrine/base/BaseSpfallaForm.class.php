...
/**
 * Spfalla form base class.
 *
 * @method Spfalla getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseSpfallaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'falla_des' => new sfValidatorString(array('max_length' => 60, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('spfalla[%s]');
