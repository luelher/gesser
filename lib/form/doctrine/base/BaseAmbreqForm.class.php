...
/**
 * Ambreq form base class.
 *
 * @method Ambreq getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseAmbreqForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'req_num'    => new sfWidgetFormInputCheckbox(),
      'solicitar'  => new sfWidgetFormInputCheckbox(),
      'entregar'   => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'req_num'    => new sfValidatorBoolean(array('required' => false)),
      'solicitar'  => new sfValidatorBoolean(array('required' => false)),
      'entregar'   => new sfValidatorBoolean(array('required' => false)),
      'rowguid'    => new sfValidatorString(array('max_length' => 36, 'required' => false)),
      'trasnfe'    => new sfValidatorString(array('max_length' => 1, 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('ambreq[%s]');
