...
/**
 * RengCac form base class.
 *
 * @method RengCac getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseRengCacForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reng_cac[%s]');
