...
/**
 * ComiPre form base class.
 *
 * @method ComiPre getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseComiPreForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'co_comi'   => new sfWidgetFormInputHidden(),
      'tipo_ven'  => new sfWidgetFormInputHidden(),
      'tipo_comi' => new sfWidgetFormInputHidden(),
      'tipo_prec' => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      'co_comi'   => new sfValidatorChoice(array('choices' => array($this->getObject()->get('co_comi')), 'empty_value' => $this->getObject()->get('co_comi'), 'required' => false)),
      ...
      'tipo_comi' => new sfValidatorChoice(array('choices' => array($this->getObject()->get('tipo_comi')), 'empty_value' => $this->getObject()->get('tipo_comi'), 'required' => false)),
      'tipo_prec' => new sfValidatorChoice(array('choices' => array($this->getObject()->get('tipo_prec')), 'empty_value' => $this->getObject()->get('tipo_prec'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('comi_pre[%s]');
