...
abstract class BaseZonaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'zon_des'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      'co_zon'   => new sfValidatorChoice(array('choices' => array($this->getObject()->get('co_zon')), 'empty_value' => $this->getObject()->get('co_zon'), 'required' => false)),
      'zon_des'  => new sfValidatorString(array('max_length' => 60, 'required' => false)),
