...
abstract class BaseTurnosForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'co_turno'  => new sfWidgetFormInputHidden(),
      'des_turno' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      'co_turno'  => new sfValidatorChoice(array('choices' => array($this->getObject()->get('co_turno')), 'empty_value' => $this->getObject()->get('co_turno'), 'required' => false)),
      'des_turno' => new sfValidatorString(array('max_length' => 60, 'required' => false)),
