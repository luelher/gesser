 ...
 *
 * @method RengCob getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseRengCobForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'dppago_tmp'   => new sfValidatorInteger(array('required' => false)),
      'reng_ncr'     => new sfValidatorInteger(array('required' => false)),
      'co_ven'       => new sfValidatorString(array('max_length' => 4, 'required' => false)),
