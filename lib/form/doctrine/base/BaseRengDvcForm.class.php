...
/**
 * RengDvc form base class.
 *
 * @method RengDvc getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseRengDvcForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo_prec'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'tipo_prec'  => new sfValidatorString(array('max_length' => 1, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('reng_dvc[%s]');
