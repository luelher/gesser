...
/**
 * RengAju form base class.
 *
 * @method RengAju getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseRengAjuForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TipoAju'), 'add_empty' => false)),
      ...
      'cost_unit_om' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'tipo'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TipoAju'), 'required' => false)),
      ...
      'cost_unit_om' => new sfValidatorNumber(array('required' => false)),
      'cost_unit'    => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('reng_aju[%s]');
