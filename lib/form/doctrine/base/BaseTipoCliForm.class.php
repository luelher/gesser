...
abstract class BaseTipoCliForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'precio_a' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      'tip_cli'  => new sfValidatorChoice(array('choices' => array($this->getObject()->get('tip_cli')), 'empty_value' => $this->getObject()->get('tip_cli'), 'required' => false)),
      'des_tipo' => new sfValidatorString(array('max_length' => 60, 'required' => false)),
      'precio_a' => new sfValidatorString(array('max_length' => 20, 'required' => false)),
