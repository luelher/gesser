...
/**
 * Plavent form base class.
 *
 * @method Plavent getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BasePlaventForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('plavent[%s]');
