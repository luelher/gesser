...
/**
 * Pventa form base class.
 *
 * @method Pventa getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BasePventaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'num_contro' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'num_contro' => new sfValidatorInteger(array('required' => false)),
      ...
      'forma_pag'  => new sfValidatorString(array('max_length' => 6, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('pventa[%s]');
