...
/**
 * TabIslr form base class.
 *
 * @method TabIslr getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseTabIslrForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'co_tab'   => new sfWidgetFormInputHidden(),
      'tab_des'  => new sfWidgetFormInputText(),
      'rango_ha' => new sfWidgetFormInputText(),
      'rango_de' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'tab_des'  => new sfValidatorString(array('max_length' => 60, 'required' => false)),
      'rango_ha' => new sfValidatorNumber(array('required' => false)),
      'rango_de' => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('tab_islr[%s]');
