...
/**
 * Spentre form base class.
 *
 * @method Spentre getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseSpentreForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ent_des'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'ent_des'    => new sfValidatorString(array('max_length' => 60, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('spentre[%s]');
