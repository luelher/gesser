...
/**
 * Placom form base class.
 *
 * @method Placom getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BasePlacomForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'import'     => new sfWidgetFormInputText(),
    ));
    ...
    $this->setValidators(array(
      ...
      'import'     => new sfValidatorInteger(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('placom[%s]');
