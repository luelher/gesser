...
/**
 * Compras form base class.
 *
 * @method Compras getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseComprasForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'monto_adi'  => new sfWidgetFormInputText(),
      'seriales'   => new sfWidgetFormInputText(),
      'com_relac'  => new sfWidgetFormInputText(),
      ...
      'tot_pie'    => new sfWidgetFormInputText(),
      'tot_peso'   => new sfWidgetFormInputText(),
      'n_control'  => new sfWidgetFormInputText(),
      'facgasto'   => new sfWidgetFormInputCheckbox(),
      ...
      'numplaexp'  => new sfWidgetFormInputText(),
      'numexpimp'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'monto_adi'  => new sfValidatorNumber(array('required' => false)),
      'seriales'   => new sfValidatorInteger(array('required' => false)),
      'com_relac'  => new sfValidatorInteger(array('required' => false)),
      ...
      'tot_pie'    => new sfValidatorNumber(array('required' => false)),
      'tot_peso'   => new sfValidatorNumber(array('required' => false)),
      'n_control'  => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'facgasto'   => new sfValidatorBoolean(array('required' => false)),
      ...
      'numplaexp'  => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'numexpimp'  => new sfValidatorString(array('max_length' => 20, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('compras[%s]');
