 ...
 * Kit form base class.
 *
 * @method Kit getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseKitForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'costeo'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'uni_venta' => new sfValidatorString(array('max_length' => 4, 'required' => false)),
      'costeo'    => new sfValidatorInteger(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('kit[%s]');
