...
/**
 * DevPro form base class.
 *
 * @method DevPro getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseDevProForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'num_cob'    => new sfWidgetFormInputText(),
      'mov_caj'    => new sfWidgetFormInputText(),
      'mov_ban'    => new sfWidgetFormInputText(),
      'saldoncr'   => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'num_cob'    => new sfValidatorInteger(array('required' => false)),
      'mov_caj'    => new sfValidatorInteger(array('required' => false)),
      'mov_ban'    => new sfValidatorInteger(array('required' => false)),
      'saldoncr'   => new sfValidatorNumber(array('required' => false)),
      ...
      'factura'    => new sfValidatorString(array('max_length' => 20, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('dev_pro[%s]');
