 ...
 *
 * @method CtaIngr getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseCtaIngrForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'co_ingr'    => new sfValidatorChoice(array('choices' => array($this->getObject()->get('co_ingr')), 'empty_value' => $this->getObject()->get('co_ingr'), 'required' => false)),
