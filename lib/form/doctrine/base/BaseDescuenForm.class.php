...
/**
 * Descuen form base class.
 *
 * @method Descuen getObject() Returns the current form's model object
 *
 * @package    gesser
 * @subpackage form
 ...
 */
abstract class BaseDescuenForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'co_desc'   => new sfWidgetFormInputHidden(),
      'tipo_cli'  => new sfWidgetFormInputHidden(),
      'tipo_desc' => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      'co_desc'   => new sfValidatorChoice(array('choices' => array($this->getObject()->get('co_desc')), 'empty_value' => $this->getObject()->get('co_desc'), 'required' => false)),
      ...
      'tipo_desc' => new sfValidatorChoice(array('choices' => array($this->getObject()->get('tipo_desc')), 'empty_value' => $this->getObject()->get('tipo_desc'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('descuen[%s]');
