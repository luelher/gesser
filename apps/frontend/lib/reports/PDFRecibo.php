...
class PDFRecibo extends sfTCPDF {
  ...
  public function MyHeader()
  {
    ...
    public function Body($id)
    {
      ...
      $servicio = Doctrine::getTable('Servicios')->findOneBy('id', $id);
      if($servicio){

        $this->SetFont('helvetica', '', 12);
        
        $this->setXY(15,35);
        $this->Cell(80, 0, 'Hemos recibido del Sr/Sra: '.trim($servicio->getNombre()).', ');
        $this->setXY(15,40);
        $this->Cell(80, 0, 'C.I Nro. '.$servicio->getCliente().', en Fecha '.date('d/m/Y',strtotime($servicio->getFecha())));
        $this->setXY(15,45);
        $this->Cell(80, 0, 'los siguientes equipos:');
        $this->setXY(30,55);
        ...
        $this->SetFont('helvetica', '', 12);
        $this->setXY(15,70);
        $this->Cell(120, 0, 'Presentando el siguiente problema: ');
        $this->setXY(15,77);
        $this->MultiCell(180, 35, $servicio->getSituacion(), true, 'L');
        $this->setXY(15,112);
        $this->MultiCell(180, 15, 'Observaciones: '.$servicio->getObservacion(), false, 'L');
