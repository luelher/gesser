 ...
 */
class sfWidgetFormJQueryDataCatalogAutocompleter extends sfWidgetFormInput
{
  /**
...
//    $this->addRequiredOption('field_search', '');
//    $this->addRequiredOption('field_description', '');
...
//    $search = $this->getOption('field_search');
//    $description = $this->getOption('field_description');
...
EOF
  ...
  {
    return array('/sfCatalogDataPlugin/css/jquery.autocompleter.css' => 'all');
  }
  ...
  {
    return array('/sfCatalogDataPlugin/js/jquery.autocompleter.js');
  }
}
