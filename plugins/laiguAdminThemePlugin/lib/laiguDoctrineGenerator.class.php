 ...
 *
 */
class laiguDoctrineGenerator extends sfDoctrineGenerator
{
  // LAIGU Theme
  /**
  ...
  public function renderField($field)
  {
    ...
    if ($field->isLink())
    {
      $html = sprintf("link_to(%s, '%s', \$%s, array('class'=>'laigu_ajax'))", $html, $this->getUrlForAction('edit'), $this->getSingularName());
    }
