...
<?php if ($this->configuration->getValue('list.batch_actions')): ?>
          <th id="sf_admin_list_batch_actions"><input id="sf_admin_list_batch_checkbox" type="checkbox" onclick="checkAll(this);" /></th>
<?php endif; ?>
...
{
  // to avoid problems with multiple details, this function checks if check all checkbox and the checkbox has the same parent
  var elp = Ext.get(el).parent("div.sf_admin_list");
  Ext.select("input[type=checkbox]").each(function(e){
    myParent = Ext.get(e).parent("div.sf_admin_list");
    if (elp == myParent) e.dom.checked = el.checked;
  });
}
/* ]]> */
</script>
